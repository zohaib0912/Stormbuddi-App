...
const MARKER_ICON_OPTIONS = [
  { id: 'default', label: 'Default', value: 'default', image: require('../assets/images/Monitoring.png') },
            ...
            <View style={styles.searchContainer} pointerEvents="box-none">
              <View style={styles.searchInputWrapper}>
                <GooglePlacesAutocomplete
                  ...
                  listViewDisplayed={searchAddressText && searchAddressText.length > 0 ? showPlacesList : false}
                  onFocus={() => {
